"""
Django settings for tuba_test_45425 project.
...
ROOT_URLCONF = 'tuba_test_45425.urls'
...
WSGI_APPLICATION = 'tuba_test_45425.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tuba_test_45425 API",
    "DESCRIPTION": "API documentation for tuba_test_45425 App",
    "VERSION": "v1",
}
